...
import {GrimmoryMarkComponent} from './shared/components/grimmory-mark/grimmory-mark.component';
...
@Component({
  ...
  standalone: true,
  imports: [ConfirmDialog, Toast, RouterOutlet, TranslocoDirective, TranslocoPipe, GrimmoryMarkComponent]
})
